...
export interface CanvasKit {
    ...
    readonly SkPDFDocument: SkPDFDocumentConstructor;
    readonly SkWStream: SkWStreamConstructor;
...
export interface SkPDFDocument extends EmbindObject<"SkPDFDocument"> {
    /**
     * Begins a new page with the given dimensions.
     * @param width
     * @param height
     * @returns a canvas that can be used to draw to the page.
     */
    beginPage(width: number, height: number): Canvas;

    /**
     * Ends the current page and appends to the document.
     */
    endPage(): void;

    /**
     * Closes the document and writes the result to the stream.
     */
    close(): void;
}

export interface SkWStream extends EmbindObject<"SkWStream"> {
    /**
     * Returns the current contents of the stream as a Uint8Array.
     */
...
export interface SkPDFDocumentConstructor {
    /**
     * A class for creating a PDF document.
     */
    new(stream: SkWStream): SkPDFDocument;
}

export interface SkWStreamConstructor {
    /**
